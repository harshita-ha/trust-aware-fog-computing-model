...
public class CrowdSensing_Microservices_RandomMobility_Clustering {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //initializing cloudsim-> num of users, time, trace?
             ...
             */
            //now all the applications are in appList
            ...
            //what about dynamic distributed clustering?
...
//            	System.out.println(device.getId()+"\n\n\n");
            	if(device.getName().startsWith("g")) {
            		Map<String, Integer> placedMicroservicesMap = new HashMap<>();
                    placedMicroservicesMap.put("trustModuleGateway", device.getId());
                    PlacementRequest p = new PlacementRequest("example", device.getId(), device.getId(), placedMicroservicesMap);
                    placementRequests.add(p);
            	}
            	else if(device.getName().startsWith("p")) {
            		Map<String, Integer> placedMicroservicesMap = new HashMap<>();
                    placedMicroservicesMap.put("trustModuleProxy", device.getId());
                    PlacementRequest p = new PlacementRequest("example", device.getId(), device.getId(), placedMicroservicesMap);
                    placementRequests.add(p);
            	}
            }
...
//            ModuleMapping moduleMapping = ModuleMapping.createModuleMapping();
            ...
            for (int i = 0; i < locator.getLevelWiseResources(locator.getLevelID("Proxy")).size(); i++) {
                ...
                proxy.setLevel(1);
//                moduleMapping.addModuleToDevice("turstModuleProxy",proxy.getName());
            ...
            for (int i = 0; i < locator.getLevelWiseResources(locator.getLevelID("Gateway")).size(); i++) {
                ...
                gateway.setLevel(2);
//                moduleMapping.addModuleToDevice("turstModuleGateway",gateway.getName());
    ...
    private static Application createApplication(String appId, int userId) {
        ...
        application.addAppModule("trustModuleGateway", 512, 250,200);
        application.addAppModule("trustModuleProxy", 512, 400,200);
        application.addAppModule("database", 512,150,2048);
//        application.addAppModule("data_module_sensor", 10,150,100);
//        application.addAppModule("data_module_proxy", 10,150,100);
        
//        application.addAppModule("trustModuleGateway", 256, 150, 100);
//        application.addAppModule("trustModuleProxy", 512, 400, 200);
        ...
        application.addAppEdge("M-SENSOR", "sensorModule", 0, 0, "M-SENSOR", Tuple.UP, AppEdge.SENSOR); // as sensor and mobile device are both same. this is a dummy edge.
                ...
                application.addAppEdge("sensorModule", "trustModuleGateway", 2000, 500, "M-SENSOR-OUTPUT", Tuple.UP, AppEdge.SENSOR);
//        application.addAppEdge("sensorModule", "trustModuleGateway", 2000, 500, "M-SENSOR-OUTPUT", Tuple.UP, AppEdge.SENSOR);

        application.addAppEdge("trustModuleGateway", "trustModuleProxy", 3500, 500, "RAW_DATA", Tuple.UP, AppEdge.MODULE);
//        application.addAppEdge("trustModuleGateway", "trustModuleProxy", 2000, 500, "M-SENSOR-OUTPUT", Tuple.UP, AppEdge.MODULE);

        
        application.addAppEdge("trustModuleProxy", "database", 1000, 1000, "PROCESSED_DATA", Tuple.UP, AppEdge.MODULE);
//        application.addAppEdge("trustModuleProxy", "database", 1000, 1000, "PROCESSED_DATA", Tuple.UP, AppEdge.MODULE);
...
//        application.addAppEdge("sensorModule", "trustModuleGateway", 2000, 500, "M-SENSOR-OUTPUT", Tuple.UP, AppEdge.SENSOR);
        ...
        application.addTupleMapping("trustModuleGateway", "M-SENSOR-OUTPUT", "RAW_DATA", new FractionalSelectivity(1.0));
//        application.addTupleMapping("trustModuleGateway", "M-SENSOR-OUTPUT", "RAW_DATA", new FractionalSelectivity(1.0));

        
        application.addTupleMapping("trustModuleProxy", "RAW_DATA", "PROCESSED_DATA", new FractionalSelectivity(1.0));
//        application.addTupleMapping("trustModuleProxy", "RAW_DATA", "PROCESSED_DATA", new FractionalSelectivity(1.0));
...
//        application.setSpecialPlacementInfo("database", "cloud");
        ...
        for(int i=0;i<12;i++) {
        	application.setSpecialPlacementInfo("trustModuleProxy","proxy-server_"+i);
        }
        
        for(int i=0;i<118;i++) {
        	application.setSpecialPlacementInfo("trustModuleGateway","gateway_"+i);
        }
...
//         * CHANGE
//         */
////        application.addAppModule("trustModuleGateway", 512,250,2048);
////        application.addAppModule("trustModuleProxy", 512,250,2048);
//        
//
//        /*
//         * Connecting the application modules (vertices) in the application model (directed graph) with edges
//         */
//        //Tuple.UP -> direction of tuple 
//        //appedge.sensor because camera is sensor
//        //trustModuleGateway and trustModuleProxy, module to module connection -? AppEdge.Module
//        //5th term is the output you will get
//        application.addAppEdge("M-SENSOR", "sensorModule", 0, 0, "M-SENSOR", Tuple.UP, AppEdge.SENSOR); // as sensor and mobile device are both same. this is a dummy edge.
//        /*
//         * CHANGE
//         */
////        application.addAppEdge("sensorModule","trustModuleGateway", 2000, 2000, "TRUST-SENSOR-GATEWAY", Tuple.UP, AppEdge.SENSOR);
////        application.addAppEdge("trustModuleGateway","trustModuleProxy", 2000, 2000, "TRUST-GATEWAY-PROXY", Tuple.UP, AppEdge.MODULE);
////        application.addAppEdge("trustModuleProxy","trustModuleGateway", 2000, 2000, "TRUST-PROXY-GATEWAY", Tuple.DOWN, AppEdge.MODULE);
////
////        
////        application.addAppEdge("trustModuleGateway", "trustModuleGateway", 2000, 500, "M-SENSOR-OUTPUT", Tuple.UP, AppEdge.MODULE);
//        application.addAppEdge("sensorModule", "trustModuleGateway", 2000, 500, "M-SENSOR-OUTPUT", Tuple.UP, AppEdge.SENSOR);
//   
//        application.addAppEdge("trustModuleGateway", "trustModuleProxy", 3500, 500, "RAW_DATA", Tuple.UP, AppEdge.MODULE);
//        application.addAppEdge("trustModuleProxy", "database", 1000, 1000, "PROCESSED_DATA", Tuple.UP, AppEdge.MODULE);
...
//         * 
//         */
////        application.addTupleMapping("sensorModule", "M-SENSOR", "TRUST-SENSOR-GATEWAY", new FractionalSelectivity(1.0));
//        application.addTupleMapping("sensorModule", "M-SENSOR", "M-SENSOR-OUTPUT", new FractionalSelectivity(1.0));
//      
////        application.addTupleMapping("trustModuleGateway", "TRUST-SENSOR-GATEWAY", "TRUST-GATEWAY-PROXY", new FractionalSelectivity(1.0));
////        application.addTupleMapping("trustModuleProxy", "TRUST-GATEWAY-PROXY", "TRUST-PROXY-GATEWAY", new FractionalSelectivity(1.0));
////        application.addTupleMapping("trustModuleGateway", "TRUST-PROXY-GATEWAY", "M-SENSOR-OUTPUT", new FractionalSelectivity(1.0));
//
//        application.addTupleMapping("trustModuleGateway", "M-SENSOR-OUTPUT", "RAW_DATA", new FractionalSelectivity(1.0));
//        application.addTupleMapping("trustModuleProxy", "RAW_DATA", "PROCESSED_DATA", new FractionalSelectivity(1.0));
//
//      application.setSpecialPlacementInfo("database", "cloud");
////      application.setSpecialPlacementInfo("trustModuleProxy", "proxy-server_0");
////      application.setSpecialPlacementInfo("trustModuleGateway", "gateway_117");
//
//      
//
//        return application;